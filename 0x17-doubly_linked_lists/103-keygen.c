...
/**
 * find4 - finds the biggest number
 *
 * @usrn: username
...
/**
 * find5 - multiplies each char of username
 *
 * @usrn: username
 * @len: length of username
...
int main(int argc, char **argv)
{
	...
	/* ----------- f4 ----------- */
	keygen[3] = ((char *)alph)[find4(argv[1], len)];
	/* ----------- f5 ----------- */
	keygen[4] = ((char *)alph)[find5(argv[1], len)];
	/* ----------- f6 ----------- */
	keygen[5] = ((char *)alph)[find6(argv[1])];
	keygen[6] = '\0';
